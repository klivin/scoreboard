...
- Localhost (2026-09-11, remaining-basis PR): Add CDNS start-mark **289.37**, Bought 2 @ **270** → Entry **$270.00 remaining · $540.00** (not 289.37), % **7.17%** vs Price $289.37. Fill Edit cost → **275** → Entry **$275.00 · $550**. Parent Edit cost → **280** → Entry **$280.00 · $560**. Import synthetic Positions FAKE1 → Entry **$25.00 remaining · $150.00** (not last $40), 60% / $90. Fill Edit cost → **26** → Entry **$26.00 · $156**, REAL cost $156 / $84 / 53.85%. No private CSV.
